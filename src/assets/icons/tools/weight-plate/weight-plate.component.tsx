import { StyledWeightPlate } from "./weight-plate.styles";

const WeightPlate = () => {
    return (
        <StyledWeightPlate version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xmlSpace="preserve">
            <g>
                <g>
                    <g>
