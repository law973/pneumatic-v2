    ...
    return (
        <DietContainer>
            <Card cardType={CARD_TYPE_CLASSES.diet}>
                ...
                <Heading headingType={HEADING_TYPE_CLASSES.headingTwo}><FastFood/>&nbsp;General Advice</Heading>
                ...
                <Heading headingType={HEADING_TYPE_CLASSES.headingTwo}>Calories</Heading>
