    ...
    return (
        <DietContainer>
            <Card cardType={CARD_TYPE_CLASSES.diet}>
                ...
                <p>The word "fitness" might bring exercise to mind first, but having a good diet is critical for your progress and overall health. This section delves into general dietary advice, the importance of calories, and the role of nutrients (both macro and micro).</p>

                <Header headerType={HEADER_TYPE_CLASSES.secondary}><FastFood/>General Advice</Header>
                <p>Before getting into the finer details, there may be a couple of small adjustments you can make to your diet that will result in big differences.<br/><br/>

                First: avoid fast food and sweets.</p>

                <p>Fast food is usually high in sodium, sugar, saturated fats, and trans fats, amongst other things. On top of that, it tends to be very calorie-dense, which can pose a problem: it's the volume of the food you eat, not the caloric content, that helps to determine if you feel full, as this is what stretches the stomach. As such, it's easy to consume a lot more calories than you need when eating calorie-dense food.</p>

                <Header headerType={HEADER_TYPE_CLASSES.secondary}>Calories</Header>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam possimus enim, non rem error nostrum accusantium itaque expedita sapiente impedit, eius inventore? Dolorem voluptates excepturi, recusandae impedit libero accusantium atque.</p>
            </Card>
