    ...
    return (
        <ExerciseContainer>
            <Card cardType={CARD_TYPE_CLASSES.exercise}>
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore neque minus dolorem cupiditate enim esse! Dolore perferendis earum ab voluptatem ullam eos quis at, porro, architecto, ipsam tempora neque incidunt.</p>

                <Header headerType={HEADER_TYPE_CLASSES.tertiary}><Progressive/>Progressive Overload</Header>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi deleniti ad, rem tempore nisi laborum, saepe aspernatur qui blanditiis, fugiat consequuntur corrupti inventore voluptatem beatae ipsam atque quas hic ab.</p>

                <Header headerType={HEADER_TYPE_CLASSES.secondary}><Heart/>Cardio</Header>
                <p>Some of the most important muscle tissue to work belongs to a part of the body you can't see: your heart.</p>
            </Card>
